...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/Advanced_Kinetics_Class/project/models/Needham_model/YF_Mech_Final.cti')
...
for i in  range(len(mole_fractions)):
    ...
    try: 
        ...
        mole_frac_dict = {'CH2CFCF3': x, 'O2':1, 'N2':1.56} # 1/(1+1.56) = .39
