...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/Advanced_Kinetics_Class/project/models/RMG/Fluorine_lib/chemkin/copies/copy_chem_annotated_208.cti')
...
with open('flamespeeds_208species_39.csv', 'w+') as g:
