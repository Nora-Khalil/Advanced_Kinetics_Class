...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/Advanced_Kinetics_Class/project/models/RMG/Needham_core/chemkin/copies/copy_chem_267_annotated.cti')
...
#         phi = (12.9)*(x/(x+1+3.76))
        ...
        try:
            if i!=0:
                ...
                d=f'data_39/0.9615384615384616.csv'
                if os.path.exists(d):  
        ...
        df1 = sltn.to_pandas()
        df1.to_csv(f'data_39/{phi}_stoic.csv', index=False)            
...
# with open('flamespeeds_2species_39.csv', 'w+') as g:
