...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/Advanced_Kinetics_Class/project/models/RMG/Needham_core/chemkin/copies/copy_chem_248_annotated.cti')
...
with open('flamespeeds_248species_50.csv', 'w+') as g:
