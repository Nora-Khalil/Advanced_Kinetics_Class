...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/Advanced_Kinetics_Class/project/models/RMG/Needham_core_NIST_lib_Fluorine_lib/chemkin/copies/copy_chem_257_annotated.cti')
...
# with open('flamespeeds_257species_39.csv', 'w+') as g:
