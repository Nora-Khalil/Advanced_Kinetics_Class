...
To = 298
Po = 1e5 # ct.one_atm
gas = ct.Solution('/work/westgroup/nora/Code/projects/halogens/refrigerants/blends/redos_for_march_conference/Papas/2,3,3,3-tetrafluoropropene_Fluorine_library/chemkin/copies/copy_chem0142.cti')
...
with open('flamespeeds_142_50.csv', 'w+') as g:
